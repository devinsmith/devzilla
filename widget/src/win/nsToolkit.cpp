...
NS_IMPL_ADDREF(nsToolkit)
NS_IMPL_RELEASE(nsToolkit)

nsresult nsToolkit::QueryInterface(REFNSIID aIID, void** aInstancePtr)
{
  ...
  *aInstancePtr = NULL;
  ...
  static NS_DEFINE_IID(kClassIID, NS_ITOOLKIT_IID);
