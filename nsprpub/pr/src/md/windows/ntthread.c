...
__thread PRThread  *_pr_current_fiber;
__thread PRThread  *_pr_fiber_last_run;
__thread _PRCPU    *_pr_current_cpu;
__thread PRUintn    _pr_ints_off;
...
extern __thread PRThread *_pr_io_restarted_io;
...
PRInt32 _PR_MD_GETTHREADAFFINITYMASK(PRThread *thread, void *mask)
{
  PRInt32 rv;
